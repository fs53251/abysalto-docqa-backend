...
def test_extract_pdf_text_creates_text_json(client: TestClient, temp_data_dir: Path):
...
def test_extract_marks_empty_pages(client: TestClient, temp_data_dir: Path):
